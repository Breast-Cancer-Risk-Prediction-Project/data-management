...
core.data <- box_read("1369365287584") #WHS


# Reading incident data
# put the name of the data Box file ID inside the quotation marks
incident.data <- box_read("1369360678981") #WHS
...
# Populate "study_name" with name of Study
core_summary_report(core.dict = core.data.dict, qc_df = core.data.qc, path_output = "C:/Users/ahearntu/Documents/BCRPP Summary Stats/WHS/", study_name = "WHS")
